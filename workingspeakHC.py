	...
	try:
		while 1:
			...
			speech = LiveSpeech(
        			...
        			lm = os.path.join(model_path, '0476.lm'), # will be changed to use new language model .. more words=slower?
        			dic = os.path.join(model_path, '0476.dic') # will be changed to use new dictionary .. more words=slower?
			)
			for phrase in speech:
				...
				if(str(phrase) == "RESET ALARM" or str(phrase) == "ALARM RESET"):
					playing = False
